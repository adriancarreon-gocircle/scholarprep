      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px', display: 'grid', gridTemplateColumns: '220px 1fr', gap: 32, alignItems: 'start' }}>
        ...
        <div>
          ...
          <SectionCard id="getting-started" title="🚀 Getting Started" subtitle="Set up your account and begin practising in under 2 minutes">
            ...
            <Step number="3" text="Choose a subject from the sidebar: Mathematics, Reading, General Ability, English, or Writing." />
          ...
          {/* English */}
          <SectionCard id="english" title="📝 English" subtitle="Grammar, spelling, punctuation and language skills">
            <p style={{ fontSize: 14, color: '#374151', lineHeight: 1.75, marginBottom: 16 }}>The English section covers 24 topic areas aligned to the Australian Curriculum and common scholarship exam requirements (ACER, Edutest, AAST and NAPLAN). Questions are generated fresh each session.</p>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
              {[{ icon: '🔤', title: 'Spelling & Phonics', desc: 'Spelling rules, ie/ei, adding -ing/-ed, words ending in -y' },
              { icon: '✍️', title: 'Punctuation', desc: 'Full stops, commas, apostrophes, capital letters, question marks' },
              { icon: '📚', title: 'Grammar', desc: 'Nouns, verbs, adjectives, adverbs, tense, pronouns, prepositions' },
              { icon: '💬', title: 'Language', desc: 'Synonyms, antonyms, homophones, similes, metaphors, compound words' }].map((c, i) => (
                <div key={i} style={{ background: '#fff', borderRadius: 12, padding: '14px 16px', border: '1px solid #EDE9FE' }}>
                  <div style={{ fontSize: 20, marginBottom: 6 }}>{c.icon}</div>
                  <div style={{ fontSize: 13, fontWeight: 700, color: '#0F172A', marginBottom: 4 }}>{c.title}</div>
                  <div style={{ fontSize: 12, color: '#64748B', lineHeight: 1.5 }}>{c.desc}</div>
                </div>
            ...
            <Step number="1" text="Navigate to English in the sidebar." />
            <Step number="2" text="Choose how many questions: 5, 10, 15, 20, or 30." />
            <Step number="3" text="Optionally expand Choose topics to focus on specific areas — use + / − to set how many questions per topic." />
            <Step number="4" text="Choose Review as I go or Exam mode, then click Start Questions." />
            <div style={{ background: '#F5F3FF', border: '1px solid #DDD6FE', borderRadius: 12, padding: '16px 18px', marginBottom: 16, marginTop: 8 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#7c3aed', marginBottom: 8 }}>💡 Sequence the Steps questions</div>
              <p style={{ fontSize: 13, color: '#374151', lineHeight: 1.7, margin: '0 0 10px' }}>Under Sentence Order, you may see "Sequence the steps" questions. Four steps from a real-world process are listed out of order. Pick the answer that shows the correct sequence.</p>
              <div style={{ background: '#fff', borderRadius: 8, padding: '12px 14px', fontSize: 12, color: '#374151', border: '1px solid #EDE9FE' }}>
                <strong>Example:</strong> Steps for making toast: 1. Spread the butter &nbsp;2. Put bread in the toaster &nbsp;3. Take the bread out &nbsp;4. Get the bread from the bag<br />
                <span style={{ color: '#059669', fontWeight: 700 }}>Correct: A) 4 – 2 – 3 – 1</span>
              </div>
            </div>
            <Tip icon="📝" text="English is also available in Custom Tests — mix it with Maths, Reading and General Ability for full scholarship exam simulation." />
            <Tip icon="🇦🇺" text="All English questions use Australian spelling — colour, favourite, realise, organise — matching the conventions used in ACER and NAPLAN." />
            <Tip icon="🔑" text="Focus on apostrophes, homophones and tense consistency — these are the most common error types in NAPLAN Language Conventions." />
          </SectionCard>
          ...
          <SectionCard id="custom-test" title="🎯 Custom Tests" subtitle="Build, save and reuse your own practice tests" mock={<MockCustomTest />}>
            ...
            <Step number="3" text="Expand a subject (Mathematics, Reading, English, or General Ability) by clicking it." />
